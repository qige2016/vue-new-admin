...
封装了一个指令权限，能简单快速的实现按钮级别的权限判断。 [v-permission](https://github.com/qige2016/vue-new-admin/tree/master/src/directive/permission)
...
可以使用全局权限判断函数[checkPermission](https://github.com/qige2016/vue-new-admin/blob/master/src/utils/permission.js) ，用法和指令 `v-permission` 类似。
